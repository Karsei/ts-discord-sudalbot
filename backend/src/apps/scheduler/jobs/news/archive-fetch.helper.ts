...
export class ArchiveFetchHelper {
  ...
  static async withGlobal(
    ...
    switch (type) {
      ...
      case 'maintenance':
        return ArchiveParseHelper.parseGlobalMaintenance(
          pageParsed,
          localeBaseUrl,
          locale,
        );
  ...
  static async withKorea(
    ...
    switch (type) {
      case 'patchnote':
        return ArchiveParseHelper.parseKoreaPatchNote(
          pageParsed,
          localeBaseUrl,
        );
      case 'event':
      ...
      case 'maintenance':
        return ArchiveParseHelper.parseKoreaMaintenance(
          pageParsed,
          localeBaseUrl,
        );
      case 'updates':
